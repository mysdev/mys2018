//注：陈工修改，修改了上传图片返回的数据结构  适应 /document/upload 接口
...
var config = {
    ...
    // 上传图片，server 地址（如果有值，则 base64 格式的配置则失效）
     uploadImgServer: '/document/upload', 
...
UploadImg.prototype = {
    ...
    uploadImg: function uploadImg(files) {
        ...
        var maxLength = 1;//config.uploadImgMaxLength || 10000;
        ...
        if (uploadImgServer && typeof uploadImgServer === 'string') {
            ...
            xhr.onreadystatechange = function () {
                ...
                if (xhr.readyState === 4) {
                    ...
                    if (!hooks.customInsert && result ==null) {
                        // hook - fail
                        if (hooks.fail && typeof hooks.fail === 'function') {
                            hooks.fail(xhr, editor, result);
                        }
                        ...
                        // 数据错误
                        _this3._alert('上传图片失败', '上传图片返回结果错误，返回结果 ' + result);
                    } else {
                        if (hooks.customInsert && typeof hooks.customInsert === 'function') {
                          ...
                          /*  var data = result.data || [];
                        	...
                        	var link = result.id;
                        	 _this3.insertLinkImg('/document/'+link);
                        }
...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('height', height+'px');
        } else {
