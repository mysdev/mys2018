...
import com.jing.utils.paginator.dialect.Dialect;
import com.jing.utils.paginator.domain.PageBounds;
import com.jing.utils.paginator.domain.PageList;
import com.jing.utils.paginator.domain.Paginator;
import com.jing.utils.paginator.support.PropertiesHelper;
import com.jing.utils.paginator.support.SQLHelp;


/**
 * 
* @ClassName: OffsetLimitInterceptor  
* @Description: 为MyBatis提供基于方言(Dialect)的分页查询的插件  
* 将拦截Executor.query()方法实现分页方言的插入.
* @author li chao
* @date 2015年9月23日 下午1:36:49 
* @version V1.0  
 */
