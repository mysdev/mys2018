...
import com.jing.codeing.template.TemplatePath;
...
public class CommonPageParser
{
  ...
  static
  {
    try
    {
      String templateBasePath =  TemplatePath.class.getResource("").getPath().substring(1, TemplatePath.class.getResource("").getPath().length()-1);
