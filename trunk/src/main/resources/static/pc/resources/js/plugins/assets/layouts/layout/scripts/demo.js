...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        var setColor = function(color) {
            ...
            parent.$('#style_color').attr("href", Layout.getLayoutCssPath() + 'themes/' + color_ + ".min.css");
            if (color == 'light2') {
            	parent.$('.page-logo img').attr('src', Layout.getLayoutImgPath() + 'LOGO-invert.svg');
            } else {
            	parent.$('.page-logo img').attr('src', Layout.getLayoutImgPath() + 'LOGO.svg');
            }
        };
