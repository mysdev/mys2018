...
var ClockRecordViewModel = function () {  
    ...
    self.modify=function(){
    	$("#mainframe", parent.window.document).attr("src",'/clock/ClockRecord.html?action=Edit&id='+$(event.currentTarget).attr('data'));
    };
...
var bindPage =function(){
    ...
    jQuery.jqPaginator('#pagination', {
        ...
        onPageChange: function (num, type) {
            if (type != 'init') {
            	$("#mainframe", parent.window.document).attr("src",'/clockrecord/ClockRecordList.html?page=' + num);
            }
        }
    });
}
