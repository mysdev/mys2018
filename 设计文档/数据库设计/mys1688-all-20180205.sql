...
CREATE TABLE `tw_attendance_detail` (
  ...
  `updated_date` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '修订时间',
  PRIMARY KEY (`att_id`)
) ENGINE=InnoDB AUTO_INCREMENT=315 DEFAULT CHARSET=utf8 COMMENT='门店考勤详情';
...
INSERT INTO `tw_attendance_detail` VALUES ('261', '8', '2', '2018-02-06', '2018-02', '6', '0', '1', '2018-02-06 21:30:00', '2018-02-07 07:30:00', '0', null, '2018-02-05 21:41:16', null, '2018-02-05 21:41:16');
INSERT INTO `tw_attendance_detail` VALUES ('262', '8', '3', '2018-02-07', '2018-02', '7', '0', '1', '2018-02-07 21:30:00', '2018-02-08 07:30:00', '0', null, '2018-02-05 21:41:16', null, '2018-02-05 21:41:16');
INSERT INTO `tw_attendance_detail` VALUES ('263', '8', '4', '2018-02-08', '2018-02', '8', '0', '1', '2018-02-08 21:30:00', '2018-02-09 07:30:00', '0', null, '2018-02-05 21:41:16', null, '2018-02-05 21:41:16');
...
CREATE TABLE `tw_attendance_time` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='考勤时段 一个考勤方案至多三个时段';

-- ----------------------------
-- Records of tw_attendance_time
-- ----------------------------
INSERT INTO `tw_attendance_time` VALUES ('1', '8', '早', '21:30:00', '07:30:00');
INSERT INTO `tw_attendance_time` VALUES ('2', '8', '晚', '20:00:00', '02:00:00');
